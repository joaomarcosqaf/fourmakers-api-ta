...
# Como contribuir?
Este é um projeto privado que aceita contribuições via pull requests daqueles que tem acesso para manutenção. Este documento tem a responsabilidade de alinhar as contribuições de acordo com os padrões estabelecidos no mesmo. Em caso de dúvidas, chame o responsável por email, yjoaomarcosadm@outlook.com.
...
<div align="center">
  ...
  <br/>
    <div>
      <h1>Open Source</h1>
      <sub>Copyright © 2022 - <a href="https://github.com/joaomarcosqa">joaomarcosqa</sub></a>
    </div>
    <br/>
</div>
